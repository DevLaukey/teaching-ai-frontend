    ...
    <div className="relative bg-gradient-to-r from-blue-500 to-teal-500 min-h-screen flex flex-col items-center justify-center text-white">
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-6">
        ...
        <div className="flex space-x-4">
          {/* Primary CTA */}
          <button
            className="bg-teal-600 hover:bg-teal-700 text-white py-3 px-6 rounded-lg shadow-md transition duration-300"
          ...
          {/* Secondary CTA */}
          <button
            className="bg-transparent border-2 border-white text-white py-3 px-6 rounded-lg shadow-md hover:bg-white hover:text-teal-600 transition duration-300"
