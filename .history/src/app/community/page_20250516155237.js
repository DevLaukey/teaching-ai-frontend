...
const CommunitySharing = () => {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      console.log("Using token for community courses fetch:", token);
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/courses/?${queryParams}`,
        {
          headers: {
      ...
      console.log("Community courses data received:", data);
      setCourses(data);
  ...
  const togglePublished = async (courseId) => {
    ...
    try {
      ...
      console.log(`Toggling published status for course ${courseId}`);
      ...
      console.log(`Toggle published response status: ${response.status}`);
