...
const ContentPreview = () => {
  ...
  const processSlides = (rawSlides) => {
    ...
    for (const slide of rawSlides) {
      ...
      if (
        slide.title.startsWith("### Slide") ||
        slide.title.includes("**Slide")
      ) {
        // New slide starts
        if (currentSlide.id) {
          processedSlides.push({ ...currentSlide });
        ...
        slide.title.startsWith("Content:") ||
        slide.title.includes("**Content:**")
      ) {
        ...
        slide.title.includes("**Examples:**")
      ) {
        currentSlide.examples =
          slide.content ||
          slide.title.replace(/Examples:|^\*\*Examples:\*\*\s*/, "").trim();
      } else if (
        ...
        currentSlide.interactiveActivity =
          ...
          slide.title
            .replace(
              /Interactive activity:|Activity:|^\*\*Activity:\*\*\s*/,
              ""
            )
            .trim();
      } else if (
