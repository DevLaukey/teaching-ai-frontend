  ...
  const updateSlide = useCallback(
    (changes) => {
      setSlides((prevSlides) => {
        ...
        const newHistory = [...history.slice(0, currentHistoryIndex + 1), newSlides];
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button variant="outline" className="space-x-2" onClick={saveDraft}>
                  ...
                  {slides.map((slide, index) => (
                    <div
                      ...
                      className={`cursor-pointer border rounded p-2 text-center ${
                        index === currentSlide ? "border-blue-500 bg-blue-50" : "hover:bg-gray-50"
                      }`}
