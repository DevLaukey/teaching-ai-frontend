      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-6">
        ...
        <div className="flex space-x-4">
          ...
          <Link href="/create-course">
            <a className="bg-teal-600 hover:bg-teal-700 text-white py-3 px-6 rounded-lg shadow-md transition duration-300">
          ...
          {/* Secondary CTA */}
          <Link href="/features">
            <a className="bg-transparent border-2 border-white text-white py-3 px-6 rounded-lg shadow-md hover:bg-white hover:text-teal-600 transition duration-300">
              Learn More
            </a>
          </Link>
        </div>
      ...
      <nav className="absolute top-0 left-0 w-full bg-transparent py-6 px-8 z-10">
        <div className="flex justify-between items-center">
          ...
          <div className="space-x-6">
            ...
            <Link href="/about">
              <a className="text-white hover:text-teal-300 transition duration-300">
                About
              </a>
            </Link>
            <Link href="/contact">
